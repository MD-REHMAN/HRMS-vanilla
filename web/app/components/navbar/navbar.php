    ...
    <nav class="navbar rightNav">
      <ul class="navList pull-right">
        <li class="dropdown navItem active">
          <a href="#" class="dropdown-toggle userAvatar" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span>{{firstName}}</span><span class="caret"></span></a>
          <ul class="dropdown-menu">
